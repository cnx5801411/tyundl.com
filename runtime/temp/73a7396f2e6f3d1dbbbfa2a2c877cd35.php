<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:59:"D:\www\www.sm.cn\addons\cms\view\default\list_download.html";i:1574242084;s:59:"D:\www\www.sm.cn\addons\cms\view\default\common\layout.html";i:1574242084;s:66:"D:\www\www.sm.cn\addons\cms\view\default\common\item_download.html";i:1574242084;}*/ ?>
<!DOCTYPE html>
<!--[if lt IE 7]>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <?php $__9A5NdrLk3Y__ = \addons\cms\model\Channel::getChannelList(["id"=>"nav","type"=>"top","condition"=>"1=isnav"]); if(is_array($__9A5NdrLk3Y__) || $__9A5NdrLk3Y__ instanceof \think\Collection || $__9A5NdrLk3Y__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__9A5NdrLk3Y__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$nav): $mod = ($i % 2 );++$i;?>
                    <!--判断是否有子级或高亮当前栏目-->
                    <li class="<?php if($nav['has_child']): ?>dropdown<?php endif; if($nav->is_active): ?> active<?php endif; ?>">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            <?php $__LuizwQByOh__ = \addons\cms\model\Channel::getChannelList(["id"=>"sub","type"=>"son","typeid"=>$nav['id'],"condition"=>"1=isnav"]); if(is_array($__LuizwQByOh__) || $__LuizwQByOh__ instanceof \think\Collection || $__LuizwQByOh__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__LuizwQByOh__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$sub): $mod = ($i % 2 );++$i;?>
                            <li><a href="<?php echo $sub['url']; ?>"><?php echo $sub['name']; ?></a></li>
                            <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__LuizwQByOh__; ?>
                        </ul>
                    </li>
                    <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__9A5NdrLk3Y__; ?>
                </ul>
...
<div class="container" id="content-container">
    ...
    <h1 class="category-title">
        ...
        <div class="more pull-right">
            <ol class="breadcrumb">
                <!-- S 面包屑导航 -->
                <?php $__z6RL79N5mu__ = \addons\cms\model\Channel::getBreadcrumb(isset($__CHANNEL__)?$__CHANNEL__:[], isset($__ARCHIVES__)?$__ARCHIVES__:[], isset($__TAGS__)?$__TAGS__:[], isset($__PAGE__)?$__PAGE__:[]); if(is_array($__z6RL79N5mu__) || $__z6RL79N5mu__ instanceof \think\Collection || $__z6RL79N5mu__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__z6RL79N5mu__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
                <li><a href="<?php echo $item['url']; ?>"><?php echo $item['name']; ?></a></li>
                <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__z6RL79N5mu__; ?>
                <!-- E 面包屑导航 -->
            </ol>
        </div>
    </h1>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="tabs-wrapper">
                <?php $__04FIBf1bOi__ = \addons\cms\model\Archives::getPageFilter($__FILTERLIST__, ["id"=>"filter","exclude"=>""]); if(is_array($__04FIBf1bOi__) || $__04FIBf1bOi__ instanceof \think\Collection || $__04FIBf1bOi__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__04FIBf1bOi__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$filter): $mod = ($i % 2 );++$i;?>
                ...
                <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__04FIBf1bOi__; ?>
                <!-- E 分类列表 -->
            </div>
        </div>
    </div>
            ...
            <div class="panel panel-default">
                    ...
                    <h3 class="panel-title">
                        ...
                        <div class="more">
                            <ul class="list-unstyled list-inline category-order clearfix">
                                <!-- S 排序 -->
                                <?php $__bK1vahJymc__ = \addons\cms\model\Archives::getPageOrder($__ORDERLIST__, ["id"=>"order"]); if(is_array($__bK1vahJymc__) || $__bK1vahJymc__ instanceof \think\Collection || $__bK1vahJymc__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__bK1vahJymc__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$order): $mod = ($i % 2 );++$i;?>
                                <li><a href="<?php echo $order['url']; ?>" class="<?php echo !empty($order['active'])?'active':''; ?>"><?php echo $order['title']; ?></a></li>
                                <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__bK1vahJymc__; ?>
                                <!-- E 排序 -->
                            </ul>
                        </div>
                    </h3>
                ...
                <div class="panel-body py-0">
                    <div class="article-list row">
                        <!-- S 列表 -->
                        <?php $__bX79zekNZv__ = \addons\cms\model\Archives::getPageList($__PAGELIST__, ["id"=>"item"]); if(is_array($__bX79zekNZv__) || $__bX79zekNZv__ instanceof \think\Collection || $__bX79zekNZv__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__bX79zekNZv__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
            ...
            <div class="media-body">
                ...
                <div class="article-tag">
                    ...
                    <span itemprop="date"><?php echo date("Y年m月d日", $item['publishtime']); ?></span>
                        ...
                        <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__bX79zekNZv__; ?>
                        <!-- E 列表 -->
